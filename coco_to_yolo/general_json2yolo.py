...
def convert_coco_json(json_dir='D:/crap/Eagleview/trainval/annotations/', use_segments=False, cls91to80=False):
...
if __name__ == '__main__':
    ...
    if source == 'COCO':
        convert_coco_json('D:/crap/Eagleview/trainval/annotations/')  # directory with *.json

    elif source == 'infolks':  # Infolks https://infolks.info/
        convert_infolks_json(name='out',
                             files='D:/crap/Eagleview/trainval/annotations/*.json',
                             img_path='D:/crap/Eagleview/trainval/images/')
